  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "data-[state=closed]:animate-out data-[state=open]:animate-in fixed inset-y-0 z-50 flex flex-col gap-4 overflow-y-auto border-l border-white/[0.07] bg-[#111118] p-6 text-[#f0f0f5] shadow-2xl shadow-black/50 transition-all duration-300 ease-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
          side === "right" &&
